package com.Cinema_Management_System.Customer.entity;
...
public class Customer {
    ...
    public Customer(int customerId, String customerPassword, String customerPicture, String customerName, String customerPhone, char customerSex) {
