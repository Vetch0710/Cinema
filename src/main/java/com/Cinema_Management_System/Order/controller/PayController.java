...
public class PayController {
    ...
    private final String NOTIFY_URL = "http://localhost:8080/Cinema_Management_System/notifyUrl";
    //支付宝同步通知路径,也就是当付款完毕后跳转本项目的页面,可以不是公网地址
    private final String RETURN_URL = "http://localhost:8080/Cinema_Management_System/returnUrl";
...
//验证签名通过
        if (signVerified) {
            ...
            try {
                ...
                return "redirect:" + "http://localhost:1024/#/ticket/orderFinished/" + out_trade_no;//跳转付款失败页面
